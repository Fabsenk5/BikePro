...
const bikeparks: Bikepark[] = [
    ...
    // --- München → Österreich ---
    {
        ...
        lat: 47.7712,
        lon: 12.2222,
        website: 'https://www.bikepark-samerberg.de',
        trails: 5,
        lifts: 1,
        weather: { temp: 12, condition: 'Sonnig', icon: '☀️', wind: 10, rain: 0 },
        liftStatus: 'open',
        openLifts: 1,
    },
    {
        ...
        lat: 47.6786,
        lon: 11.5794,
        website: 'https://www.bikepark-lenggries.com',
        trails: 7,
        lifts: 1,
        weather: { temp: 13, condition: 'Sonnig', icon: '☀️', wind: 8, rain: 0 },
        liftStatus: 'open',
        openLifts: 1,
    },
    {
